...
const CentralDogma = React.lazy(() => import('./biology/CentralDogma'));
...
const BiochemistryStudio = React.lazy(() => import('./biology/BiochemistryStudio'));
...
const MolecularGeometryVSEPR = React.lazy(() => import('./chemistry/MolecularGeometryVSEPR'));
...
const AlgebraicSystems = React.lazy(() => import('./math/AlgebraicSystems'));
const DataHandling = React.lazy(() => import('./math/DataHandling'));
...
const ProbabilityStatsStudio = React.lazy(() => import('./mathematics/ProbabilityStatsStudio'));
const FunctionTransformationComposer = React.lazy(() => import('./mathematics/FunctionTransformationComposer'));
const ProbabilityDistributionLab = React.lazy(() => import('./mathematics/ProbabilityDistributionLab'));
...
export const interactiveRegistry: Record<string, LazyExoticComponent<ComponentType>> = {
  ...
  'biochemistry-studio': BiochemistryStudio,
  ...
  'molecular-geometry-vsepr': MolecularGeometryVSEPR,
  ...
  'algebraic-systems': AlgebraicSystems,
  ...
  'probability-statistics-studio': ProbabilityStatsStudio,
  'function-transformation-composer': FunctionTransformationComposer,
  'probability-distribution-lab': ProbabilityDistributionLab,
