...
const StudentDashboard: React.FC<Props> = ({ user }) => {
    ...
    const handleStartQuiz = (topicId: string, questionCount: number | 'All', difficulty?: string) => {
        navigate(`/practice/${topicId}?count=${questionCount}&difficulty=${difficulty || 'all'}`);
    };
    ...
    return (
        <div id="dashboard-container" className="max-w-6xl mx-auto">
            ...
            {/* QUIZ LAUNCHER */}
            <QuizLauncher onStartQuiz={handleStartQuiz} />
