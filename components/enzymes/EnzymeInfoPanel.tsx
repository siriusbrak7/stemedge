...
import { ENZYME_CONCEPTS, EnzymeConcept, DepthLevel } from '../../data/enzymesData';
...
const EnzymeInfoPanel: React.FC<Props> = ({ conceptId, depth, onDepthChange, onSaveNote }) => {
    const concept: EnzymeConcept | undefined = conceptId ? ENZYME_CONCEPTS[conceptId] : undefined;
        ...
        return (
            <div className="h-full flex flex-col items-center justify-center text-center p-8 bg-slate-900/50 rounded-2xl border border-slate-800">
                ...
                <p className="text-slate-400">
                    Interact with the simulation to unlock detailed scientific explanations.
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="flex flex-col h-full animate-fade-in-right">
            ...
            <div className="mb-6">
                ...
                <div className="h-1 w-full bg-gradient-to-r from-yellow-500 to-red-600 rounded-full" />
            </div>
            ...
            <div className="flex-1 overflow-y-auto pr-2 mb-6">
                ...
                <div className="bg-yellow-900/10 p-4 rounded-xl border border-yellow-500/20 mb-4">
                    <div className="flex items-start gap-3">
                        <Lightbulb className="w-5 h-5 text-yellow-400 shrink-0 mt-0.5" />
                        <div>
                            <p className="text-xs font-bold text-yellow-300 uppercase mb-1">Analogy</p>
                            <p className="text-sm text-yellow-100 italic">"{concept.analogy}"</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default EnzymeInfoPanel;
