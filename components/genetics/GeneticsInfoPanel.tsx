...
import { GENETICS_CONCEPTS, GeneticsConcept, DepthLevel } from '../../data/geneticsData';
...
const GeneticsInfoPanel: React.FC<Props> = ({ conceptId, depth, onDepthChange, onSaveNote }) => {
    const concept: GeneticsConcept | undefined = conceptId ? GENETICS_CONCEPTS[conceptId] : undefined;
    ...
    if (!concept) {
        return (
            <div className="h-full flex flex-col items-center justify-center text-center p-8 bg-slate-900/50 rounded-2xl border border-slate-800">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Genetic Decoder</h3>
    ...
    return (
        <div className="flex flex-col h-full animate-fade-in-right">
            ...
            <div className="mb-6">
                ...
                <div className="h-1 w-full bg-gradient-to-r from-blue-500 to-purple-600 rounded-full" />
            </div>
            ...
            <div className="flex-1 overflow-y-auto pr-2 mb-6">
                ...
                <div className="bg-blue-900/10 p-4 rounded-xl border border-blue-500/20 mb-4">
                    <div className="flex items-start gap-3">
                        <Lightbulb className="w-5 h-5 text-blue-400 shrink-0 mt-0.5" />
                        <div>
                            <p className="text-xs font-bold text-blue-300 uppercase mb-1">Analogy</p>
                            <p className="text-sm text-blue-100 italic">"{concept.analogy}"</p>
                        </div>
                    </div>
                </div>
            </div>
...
export default GeneticsInfoPanel;
